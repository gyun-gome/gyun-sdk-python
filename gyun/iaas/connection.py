...
from gyun.iaas.actions.alarm_policy import AlarmPolicy
from gyun.iaas.actions.nic import NicAction

from gyun.conn.auth import QuerySignatureAuthHandler
from gyun.conn.connection import HttpConnection, HTTPRequest
from gyun.iaas.actions.s2 import S2Action
from gyun.misc.json_tool import json_load, json_dump
from gyun.misc.utils import filter_out_none
...
class APIConnection(HttpConnection):
    """ Public connection to gyun service
    """
    ...
    def describe_instances(self, instances=None,
        ...
        @param instance_type: The instance type.
                              See: https://docs.qc.gyun.com/api/common/includes/instance_type.html
    ...
    def resize_instances(self, instances,
        ...
        @param instance_type: defined by gyun.
                              See: https://docs.qc.gyun.com/api/common/includes/instance_type.html
        @param cpu: cpu core number.
        @param memory: memory size in MB.
        """
    ...
    def modify_router_static_attributes(self, router_static,
        ...
        @param val1 - val6: please see the doc. https://docs.qc.gyun.com/api/router/modify_router_static_attributes.html
    ...
    def modify_router_static_entry_attributes(self,
        ...
        @param val1 - val2: please see the doc. https://docs.qc.gyun.com/api/router/modify_router_static_entry_attributes.html
        """
    ...
    def create_rdb(self, vxnet=None,
        ...
        @param rdb_type: defined by gyun: 1, 2, 3, 4, 5
    ...
    def resize_mongos(self, mongos,
        ...
        @param mongo_type: defined by gyun: 1, 2, 3, 4.
                           see: https://docs.qc.gyun.com/api/mongo/resize_mongos.html
        @param cpu: cpu core number.
        @param memory: memory size in MB.
        """
    ...
    def resize_caches(self, caches,
        ...
        @param cache_size: defined by gyun: 1 - 32 GB.
        @param cpu: cpu core number.
        @param memory: memory size in MB.
        """
