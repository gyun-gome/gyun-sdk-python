...
from gyun.conn.auth import QSSignatureAuthHandler
...
class QSConnection(HttpConnection):
    """ Public connection to gomestor
    """

    def __init__(self, qy_access_key_id=None, qy_secret_access_key=None,
                 host="gomestor.com", port=443, protocol="https",
        ...
        host = host
        # Set user agent
        self.user_agent = "GomeStor SDK Python"
        # Set retry times
