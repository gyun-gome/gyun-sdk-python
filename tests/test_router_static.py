...
from gyun.iaas.errors import InvalidRouterStatic
from gyun.iaas.router_static import (RouterStaticFactory, _StaticForTunnel,
...
class RouterStaticFactoryTestCase(unittest.TestCase):
    ...
    def test_create_multiple_statics_from_string(self):
        ...
        [{
          ...
          "router_static_id": "rtrs-1234abcd", "console_id": "gyun",
...

        {
          ...
          "console_id":"gyun","val3":"tcp","controller":"self",
...

        {
          ...
          "router_static_name":null,"console_id":"gyun","val3":"253",
