...
from gyun.gomestor.multipart import MultiPartUpload, Part


class TestGomeStorBucket(MockTestCase):

    connection_class = QSConnection

    def setUp(self):
        super(TestGomeStorBucket, self).setUp()
    ...
    def test_bucket_stats(self):
        body = {
            ...
            "url": "http://tsung-get-1445508780.pek3.gomestor.com",
            "location": "pek3",
